...
import VoouFav from "../../assets/favicons/voou.png";
    ...
    <Container>
      <Helmet>
        ...
        {website === "voou-viagens" ? (
          <link rel="icon" type="image/png" href={VoouFav} sizes="16x16" />
        ) : (
          <link
            rel="icon"
            type="image/png"
            href={data.photos.logo.base64}
            sizes="16x16"
          />
        )}
      ...
      <FirstSection
        ...
        secondaryColor={
          website === "voou-viagens" ? voouColor : data.secondaryColor
        }
      ...
      >
        <SecondSection
          ...
          mainColor={data.mainColor}
          accentColor={
            website === "voou-viagens" ? voouColor : data.accentColor
          }
                ...
                <div className="img-wrapper">
                  ...
                  {website === "voou-viagens" ? (
                    <>
                      <button
                        style={{
                          backgroundColor: voouColor,
                          borderRadius:
                            website === "voou-viagens" ? "100px" : "",
                        }}
                        onClick={handleWhatsClick}
                      >
                        <FaWhatsapp size={24} />
